...
const I18N = {
  zh: {
    ...
    noServerAccount: "无需插件账号",
    sourceTitle: "回放来源",
    sourceHint: "先打开能播放的回放，再粘贴链接或使用当前页。",
    useCurrentTab: "使用当前页",
    replayLink: "回放链接",
    replayPlaceholder: "https://n.dingtalk.com/... 或 roomId=...&liveUuid=...",
    inputHint: "支持完整链接，也支持 roomId=...&liveUuid=...",
    clear: "清空",
    settingsTitle: "下载设置",
    output: "输出格式",
    mp4Option: "MP4",
    ...
    yes: "是",
    no: "否",
    errMissingParams: "没有找到 roomId 和 liveUuid。请粘贴完整回放链接，或在回放页点击“使用当前页”。",
    errNotLoggedIn: "钉钉返回当前浏览器未登录。请先在这个浏览器里打开钉钉并登录。",
    errMissingModel: "钉钉响应中没有 openLiveDetailModel。",
    errReplayRestricted: "回放存在，但钉钉没有返回播放地址。可能是回放不可用、尚未生成，或当前账号没有访问权限。",
    ...
    errNoCookies: "没有找到钉钉 Cookie。请先在这个浏览器里登录钉钉网页，再重试。",
    errCancelled: "下载已取消。",
